...
<body>
	...
	<div class="container-inf">
		...
		<form class="form-inf" action="../admin/addnewcate/submit"
			method="post">
			<h1 class="title-inf">Thêm danh mục sản phẩm</h1>
			<div class="prop-row">
			...
			<div class="prop-row">
				<label for="" class="lable-inf">Nhà sản xuất</label> 
				<select name="HangSX" class="input-inf">
